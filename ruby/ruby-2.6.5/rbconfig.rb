...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/usr/local/ruby")
  ...
  CONFIG["configure_args"] = " '--prefix=/usr/local/ruby'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/usr/local/ruby"
  ...
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "gcc (Ubuntu 5.4.0-6ubuntu1~16.04.11) 5.4.0 20160609\nCopyright (C) 2015 Free Software Foundation, Inc.\nThis is free software; see the source for copying conditions.  There is NO\nwarranty; not even for MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE."
