...
ECHO1 = $(V:1=@:)
ECHO = $(ECHO1:0=@echo)
extensions = ext/-test-/arith_seq/extract/. ext/-test-/array/resize/. \
	     ...
	     ext/-test-/thread_fd_close/. ext/-test-/time/. \
	     ext/-test-/tracepoint/. ext/-test-/typeddata/. \
	     ext/-test-/vm/. ext/-test-/wait_for_single_fd/. \
	     ext/bigdecimal/. ext/bigdecimal/util/. ext/cgi/escape/. \
	     ext/continuation/. ext/coverage/. ext/date/. ext/dbm/. \
	     ext/digest/. ext/digest/bubblebabble/. ext/digest/md5/. \
	     ...
	     ext/nkf/. ext/objspace/. ext/openssl/. ext/pathname/. \
	     ext/psych/. ext/pty/. ext/racc/cparse/. \
	     ext/rbconfig/sizeof/. ext/readline/. ext/ripper/. \
	     ext/rubyvm/. ext/sdbm/. ext/socket/. ext/stringio/. \
	     ext/strscan/. ext/syslog/. ext/zlib/.
EXTOBJS = dmyext.o
...
note-body:: note-header
	...
	@echo "	Check ext/dbm/mkmf.log for more details."
	@$(NOTE_NAME) "gdbm:"
	@echo "	Could not be configured. It will not be installed."
	@echo "	Check ext/gdbm/mkmf.log for more details."
	@$(NOTE_NAME) "openssl:"
	@echo "	Could not be configured. It will not be installed."
	@echo "	/root/redis/ruby/ruby-2.6.5/ext/openssl/extconf.rb:97: OpenSSL library could not be found. You might want to use --with-openssl-dir=<dir> option to specify the prefix where OpenSSL is installed."
